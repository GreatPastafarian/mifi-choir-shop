    ...
    },
{
    ...
    details: [
        "Запись в формате 16-bit/44.1kHz",
        "Специальная упаковка с буклетом",
        "Подписанный диск артистами"
    ],
    images: [
        "/images/products/cd-cover.jpg",
        "/images/products/cd-back.jpg",
        "/images/products/cd-bonus.jpg"
    ],
    image: "cd",
    isNew: true,
...
},
{
    ...
    images: [
        "/images/products/pin-front.jpg",
        "/images/products/pin-back.jpg"
    ],
    image: "pin",
    isNew: false,
...
},
{
    ...
    details: [
        "Двойные стенки для сохранения температуры",
        "Съемная крышка",
        "Легко моется"
    ],
    images: [
        "/images/products/mug-front.jpg",
        "/images/products/mug-side.jpg"
    ],
    image: "mug",
    isNew: true,
...
},
{
    ...
    images: [
        "/images/products/sweatshirt-front.jpg",
        "/images/products/sweatshirt-back.jpg"
    ],
    image: "sweatshirt",
    isNew: false,
...
},
{
    ...
    details: [
        ...
        "Эксклюзивная обложка",
        "Запись в студийном качестве"
    ],
    images: [
        "/images/products/vinyl-front.jpg",
        "/images/products/vinyl-back.jpg"
    ],
    image: "vinyl",
    isNew: true,
...
},
{
    ...
    images: [
        "/images/products/gift-set-front.jpg",
        "/images/products/gift-set-back.jpg"
    ],
    image: "gift-set",
    isNew: false,
